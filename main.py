...
def upload():
    ...
    # Convert contact_names to a dictionary with counts
    contact_name_counts = dict(Counter(contact_names))
    
    return render_template('results.html', contact_name_counts=contact_name_counts, last_seen_times=last_seen_times)
